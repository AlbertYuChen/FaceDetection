...
//        openCvCameraView.setMaxFrameSize(400, 200);
        openCvCameraView.enableFpsMeter();


//        setContentView(R.layout.face_detect_surface_view);
//        mOpenCvCamera = (mView) new JavaCameraView(this, -1);
////        mOpenCvCamera = (mView) findViewById(R.id.fd_activity_surface_view);
//
//        mOpenCvCamera.setCameraIndex(mOpenCvCamera.CAMERA_ID_FRONT);
//
//        mOpenCvCamera.setVisibility(SurfaceView.VISIBLE);
//        mOpenCvCamera.setCvCameraViewListener(this);

//        List<Camera.Size> mResolutionList = mOpenCvCamera.getResolutionList();;
//        Camera.Size resolution = mResolutionList.get(1);
//        mOpenCvCamera.setResolution(resolution);
